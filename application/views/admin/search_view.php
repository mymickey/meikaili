		...
		if($resp->total_results == 0){
			...
			?>
				<li>
					...
					<img data-ks-lazyload="<?php echo $taobaoke_item->pic_url?>" src="<?php echo base_url()?>assets/img/s.gif" alt="<?php echo $taobaoke_item->title?>"/>
					</a>
					<p><span class="right"><b class="red"><?php echo $taobaoke_item->volume ?></b>件/30天</span><span><?php echo $taobaoke_item->commission ?></span> / <span><?php echo $taobaoke_item->price?></span></p>
				</li>
			<?php
			}
		}
